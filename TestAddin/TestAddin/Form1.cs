        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            var count_obj = from x in list_title
                ...
                foreach (var obj in count_obj)
                {
                    ...
                    {
                        dt.Rows.Add(contentControl.title, contentControl.tag, "Yes", "Yes", obj.Count, contentControl.type_CC);
            ...
            //foreach (var contentControl in contentControlList)
            //{
            //    //contentControl.Title.Count();
            //    dt.Rows.Add(contentControl.Title, contentControl.Tag, "Yes", "Yes", contentControl.Title.Count(),contentControl.Type);
            //    dataGridView1.DataSource = dt;
            //}

            //string title = contentControlList[0].Title;
            //string tag = contentControlList[1].Tag;
            //int count = LobjActiveDocument.Count.ToString();
            //WdContentControlType type = 
            //int count = contentControlList.ContentControls.count.ToString();

            // dt.Rows.Add("Test", "Test", "Yes", "Yes", 2, "Rich Text");
